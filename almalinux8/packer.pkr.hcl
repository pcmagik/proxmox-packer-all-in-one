...
variable "almalinux_image" {
  type    = string
  default = "AlmaLinux-8.8-x86_64-dvd.iso"
}
...
variable "template_description" {
  type    = string
  default = "AlmaLinux 8.8 Template"
}

variable "template_name" {
  type    = string
  default = "packer-AlmaLinux8-Template"
}
...
source "proxmox-iso" "autogenerated_1" {
  ...
  http_directory           = "almalinux8"
  insecure_skip_tls_verify = true
  iso_file                 = "${var.proxmox_iso_pool}/${var.almalinux_image}"
  memory                   = "2048"
  network_adapters {
    bridge = "vmbr0"
    model  = "virtio"
